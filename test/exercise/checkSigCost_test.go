...
func TestOfflineCostOfSig(test *testing.T) {

	//	runtime.GOMAXPROCS(1) //uncomment this line and import runtime for single-threading

	f, _ := os.Create("../../testResults/testresult_sigCost.txt")
	defer f.Close()
	w := bufio.NewWriter(f)
